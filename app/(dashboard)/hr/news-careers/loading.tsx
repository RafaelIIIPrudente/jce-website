...
// HR · News & Careers CMS — register loading skeleton (header band → publish-state
// KPI strip → toolbar → tabs → card rows). Mirrors the BDD website CMS loading;
// shimmer collapses to a static block under prefers-reduced-motion.
