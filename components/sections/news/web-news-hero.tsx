...
// S6 News hero — the electrified dark idiom at inner-page scale, the same language
// as web-about-hero / web-services-hero / web-products-hero: an ambient circuit
...
// single <h1>. Deliberately photo-less — brand-led, and avoids the next/image
// priority-LCP src collision. Mobile-first: the headline clamps from 360px up;
// decorative layers are clipped, behind content, and static under reduced-motion.
  ...
  return (
    <section className="dark-section circuit-field relative isolate overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-24 sm:py-28 md:py-32">
        <p className="kicker text-jce-cyan-bright">Newsroom</p>
        <h1 className="mt-4 max-w-[20ch] text-[clamp(30px,6vw,60px)] leading-[1.04] font-bold tracking-[-0.02em] text-balance text-jce-dark-ink">
          News &amp; <span className="text-jce-cyan-bright">insights.</span>
        </h1>
        <p className="mt-5 max-w-[60ch] text-ui-16 text-pretty text-jce-dark-ink-2 sm:text-ui-18">
          Project milestones and perspectives on Philippine power
          infrastructure.
        </p>
      </div>
    </section>
